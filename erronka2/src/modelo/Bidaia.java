...
public class Bidaia {
    ...
    public Bidaia(String izena, String bidaiaMota, LocalDate hasieraData, LocalDate amaieraData,
                  String herrialdea, String deskripzioa) {
        this.izena = izena;
    ...
    public String toString() {
        return "Bidaia{" +
                ...
                ", egunKantitatea=" + getEgunKantitatea() +
