...
public class BidaiaTest {
	...
	private Bidaia bidaia2;
	private Bidaia bidaia3;
	...
	public void setUp() {
		...
		bidaia = new Bidaia(1, "Bidaia", "Bidaia deskribapena", "Ez Barne", bidaiHasiera, bidaiAmaiera, "ES", "B1",
				100);
		bidaia2 = new Bidaia(zerbitzuak ,1, "Bidaia", "Bidaia deskribapena", "Ez Barne", bidaiHasiera, bidaiAmaiera, "ES", "B1",
				100);
		bidaia3 = new Bidaia();
	}
	...
	@Test
	public void testGetSetZerbitzuak() {
	...
	public void testToString() {
		String expected = "Bidaia [bidaiKodea=1, izena=Bidaia, deskribapena=Bidaia deskribapena, EzBarne=Ez Barne, bidaiHasiera="
				+ bidaiHasiera + ", bidaiAmaiera=" + bidaiAmaiera
				+ ", herrialdeKod=ES, bidaiaMKod=B1, agentziaKod=100]";
